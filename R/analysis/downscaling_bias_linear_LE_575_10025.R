...
# Load the merged data for the (5.75, 100.25) location
merged_data <- read.csv("data/merged_day_location_5.75_100.25.csv")
...
LE_era5 <- merged_data$LE_era5_location_5.75_100.25  # ERA5 latent heat flux for the specific location
...
ggplot(merged_data, aes(x = date)) +
  ...
  labs(title = "Latent Heat Flux (LE) Comparison: Eddy Covariance vs. ERA5 (Point 5.75, 100.25)",
       x = "Date", y = "LE (W m–2)") +
...
ggsave("fig_paper2/LE_Comparison_Bias_Corrected_5.75_100.25.jpeg", width = 10, height = 6, dpi = 300)
...
cat("Performance Metrics for Location (5.75, 100.25):\n")
